...
- **Location**: `./mounts/ssh/`
- **Mounted to**: `/workspace/home/dev/.ssh` (overlays the volume)
...
**Solution**: 
- Docker named volume for `/workspace/home/dev` (VS Code cache with correct permissions)
